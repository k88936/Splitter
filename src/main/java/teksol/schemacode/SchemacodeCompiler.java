...
import teksol.schemacode.ast.AstDefinitions;
import teksol.schemacode.ast.AstSchematicsBuilder;
import teksol.schemacode.grammar.SchemacodeLexer;
...
public class SchemacodeCompiler {
    ...
    public static CompilerOutput<byte[]> compile(String definition, CompilerProfile compilerProfile, Path basePath) {
        ...
        SchemacodeParser.DefinitionsContext parseTree = parseSchematics(definition, messages::add);
     ...
     */
    static SchemacodeParser.DefinitionsContext parseSchematics(String definition, Consumer<CompilerMessage> messageListener) {
    ...
    static AstDefinitions createDefinitions(SchemacodeParser.DefinitionsContext parseTree, Consumer<CompilerMessage> messageListener) {
