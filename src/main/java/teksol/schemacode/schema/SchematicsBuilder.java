...
import teksol.schemacode.ast.*;
import teksol.schemacode.config.*;
import teksol.schemacode.mimex.BlockType;
import teksol.schemacode.mindustry.*;
import teksol.schemacode.schema.BlockPositionResolver.AstBlockPosition;
...
public class SchematicsBuilder {
    ...
    public Schematic buildSchematics() {
        ...
        positionMap = BlockPositionMap.forBuilder(m -> {
        }, blocks);
