...
public class Decompiler {
    ...
    public String buildCode() {
        ...
        (switch (blockOrder) {
            ...
            case HORIZONTAL ->
                    schematic.blocks().stream().sorted(Comparator.comparing(Block::y).thenComparing(Block::x));
    ...
    private String getLinkName(ProcessorConfiguration processor, ProcessorConfiguration.Link link) {
    ...
    private void writeLink(Block block, ProcessorConfiguration processor, ProcessorConfiguration.Link link) {
