...
package teksol.schemacode.grammar;
...
public class SchemacodeParser extends Parser {
    ...
    public static class DefinitionsContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(SchemacodeParser.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitDefinitions(this);
    ...
    public static class DefinitionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitDefinition(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class SchematicContext extends ParserRuleContext {
        ...
        public TerminalNode Colon() {
            return getToken(SchemacodeParser.Colon, 0);
        }

        public TerminalNode End() {
            return getToken(SchemacodeParser.End, 0);
        }

        public TerminalNode Id() {
            return getToken(SchemacodeParser.Id, 0);
        }

        public TerminalNode Schematic() {
            return getToken(SchemacodeParser.Schematic, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_schematic;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitSchematic(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class SchematicItemContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_schematicItem;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitSchematicItem(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NameContext extends AttributeContext {
        ...
        public NameContext(AttributeContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Assign() {
            return getToken(SchemacodeParser.Assign, 0);
        }

        public TerminalNode Name() {
            return getToken(SchemacodeParser.Name, 0);
        }
    ...
    public static class SchemaTagContext extends AttributeContext {
        ...
        public SchemaTagContext(AttributeContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode Tag() {
            return getToken(SchemacodeParser.Tag, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitSchemaTag(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class DescriptionContext extends AttributeContext {
        ...
        public DescriptionContext(AttributeContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode Description() {
            return getToken(SchemacodeParser.Description, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitDescription(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class DimensionsContext extends AttributeContext {
        public DimensionsContext(AttributeContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode Dimensions() {
            return getToken(SchemacodeParser.Dimensions, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitDimensions(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class BlockContext extends ParserRuleContext {
        ...
        public TerminalNode At() {
            return getToken(SchemacodeParser.At, 0);
        }

        public TerminalNode Ref() {
            return getToken(SchemacodeParser.Ref, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitBlock(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class LabelListContext extends ParserRuleContext {
        ...
        public List<TerminalNode> Comma() {
            return getTokens(SchemacodeParser.Comma);
        }
        ...
        public List<TerminalNode> Id() {
            return getTokens(SchemacodeParser.Id);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitLabelList(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PositionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitPosition(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class CoordinatesContext extends ParserRuleContext {
        ...
        public TerminalNode Comma() {
            return getToken(SchemacodeParser.Comma, 0);
        }

        public List<TerminalNode> Int() {
            return getTokens(SchemacodeParser.Int);
        }
        ...
        public TerminalNode LeftParen() {
            return getToken(SchemacodeParser.LeftParen, 0);
        }

        public TerminalNode RightParen() {
            return getToken(SchemacodeParser.RightParen, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_coordinates;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitCoordinates(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RelativeCoordinatesContext extends ParserRuleContext {
        ...
        public TerminalNode Minus() {
            return getToken(SchemacodeParser.Minus, 0);
        }

        public TerminalNode Plus() {
            return getToken(SchemacodeParser.Plus, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_relativeCoordinates;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitRelativeCoordinates(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class CoordinatesRelativeToContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SchemacodeListener)
                ((SchemacodeListener) listener).enterCoordinatesRelativeTo(this);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_coordinatesRelativeTo;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitCoordinatesRelativeTo(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class DirectionContext extends ParserRuleContext {
        ...
        public TerminalNode East() {
            return getToken(SchemacodeParser.East, 0);
        }

        public TerminalNode Facing() {
            return getToken(SchemacodeParser.Facing, 0);
        }

        public TerminalNode North() {
            return getToken(SchemacodeParser.North, 0);
        }

        public TerminalNode South() {
            return getToken(SchemacodeParser.South, 0);
        }

        public TerminalNode West() {
            return getToken(SchemacodeParser.West, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitDirection(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VirtualContext extends ConfigurationContext {
        public VirtualContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Virtual() {
            return getToken(SchemacodeParser.Virtual, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitVirtual(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ItemContext extends ConfigurationContext {
        public ItemContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Item() {
            return getToken(SchemacodeParser.Item, 0);
        }
    ...
    public static class UnitContext extends ConfigurationContext {
        public UnitContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode Unit() {
            return getToken(SchemacodeParser.Unit, 0);
        }
    ...
    public static class BooleanContext extends ConfigurationContext {
        ...
        public BooleanContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Disabled() {
            return getToken(SchemacodeParser.Disabled, 0);
        }

        public TerminalNode Enabled() {
            return getToken(SchemacodeParser.Enabled, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitBoolean(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ColorContext extends ConfigurationContext {
        public ColorContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Color() {
            return getToken(SchemacodeParser.Color, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitColor(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class LiquidContext extends ConfigurationContext {
        public LiquidContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Liquid() {
            return getToken(SchemacodeParser.Liquid, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitLiquid(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class TextContext extends ConfigurationContext {
        ...
        public TextContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Text() {
            return getToken(SchemacodeParser.Text, 0);
        }
    ...
    public static class LogicContext extends ConfigurationContext {
        ...
        public LogicContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitLogic(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ConnectionsContext extends ConfigurationContext {
        public ConnectionsContext(ConfigurationContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Connected() {
            return getToken(SchemacodeParser.Connected, 0);
        }

        public TerminalNode To() {
            return getToken(SchemacodeParser.To, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitConnections(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ColorDefContext extends ParserRuleContext {
        ...
        public TerminalNode Rgba() {
            return getToken(SchemacodeParser.Rgba, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_colorDef;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitColorDef(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConnectionListContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_connectionList;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitConnectionList(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConnAbsContext extends ConnectionContext {
        public ConnAbsContext(ConnectionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitConnAbs(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ConnNameContext extends ConnectionContext {
        public ConnNameContext(ConnectionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitConnName(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ConnRelContext extends ConnectionContext {
        public ConnRelContext(ConnectionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitConnRel(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ProcessorContext extends ParserRuleContext {
        ...
        public TerminalNode Mindcode() {
            return getToken(SchemacodeParser.Mindcode, 0);
        }

        public TerminalNode Mlog() {
            return getToken(SchemacodeParser.Mlog, 0);
        }

        public TerminalNode Processor() {
            return getToken(SchemacodeParser.Processor, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitProcessor(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ProcessorLinksContext extends ParserRuleContext {
        ...
        public TerminalNode Links() {
            return getToken(SchemacodeParser.Links, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_processorLinks;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitProcessorLinks(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class LinkPatternContext extends LinkDefContext {
        ...
        public LinkPatternContext(LinkDefContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode Pattern() {
            return getToken(SchemacodeParser.Pattern, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitLinkPattern(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class LinkPosContext extends LinkDefContext {
        ...
        public LinkPosContext(LinkDefContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode As() {
            return getToken(SchemacodeParser.As, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitLinkPos(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ProgramStringContext extends ProgramContext {
        ...
        public ProgramStringContext(ProgramContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitProgramString(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class ProgramFileContext extends ProgramContext {
        ...
        public ProgramFileContext(ProgramContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode File() {
            return getToken(SchemacodeParser.File, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitProgramFile(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class TextIdContext extends TextDefContext {
        ...
        public TextIdContext(TextDefContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitTextId(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class TextLiteralContext extends TextDefContext {
        ...
        public TextLiteralContext(TextDefContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitTextLiteral(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class StringValueContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitStringValue(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class TextLineContext extends StringLiteralContext {
        public TextLineContext(StringLiteralContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode TextLine() {
            return getToken(SchemacodeParser.TextLine, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitTextLine(this);
            else return visitor.visitChildren(this);
        }
    ...
    public static class TextBlockContext extends StringLiteralContext {
        public TextBlockContext(StringLiteralContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode TextBlock1() {
            return getToken(SchemacodeParser.TextBlock1, 0);
        }

        public TerminalNode TextBlock2() {
            return getToken(SchemacodeParser.TextBlock2, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SchemacodeVisitor)
                return ((SchemacodeVisitor<? extends T>) visitor).visitTextBlock(this);
            else return visitor.visitChildren(this);
        }
