...
import teksol.schemacode.ast.AstLink;
import teksol.schemacode.ast.AstProcessor;
import teksol.schemacode.config.ByteArray;
import teksol.schemacode.config.Configuration;
import teksol.schemacode.schema.Block;
import teksol.schemacode.schema.BlockPosition;
    ...
    private static String convertToMlog(SchematicsBuilder builder, AstProcessor processor) {
        return switch (processor.language()) {
            ...
            case MINDCODE -> {
                ...
                CompilerOutput<String> output = compile(processor.program().getProgramText(builder),
